...
1. ### *create configuration file by web page* ###
...
2. ### *test configuration file without server* ###
...
3. ### *fast check some enviroment tips by console* ###
...
5. ### *other code tips when something goes wrong* ###
